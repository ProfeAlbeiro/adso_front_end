		...
		<div class="titulo row">
			<div class="col p-2  border-bottom d-flex">
				...
				<div class="col-5 d-flex justify-content-end align-items-center p-0">
					<a href="?c=Usuarios&a=crear" class="btn btn-primary">Crear Usuario</a>
				</div>
			</div>
		</div>
						...
						<?php foreach($users as $user) : ?>
							<tr>
								...
								<td class="d-flex flex-row pt-2 justify-content-center">
									<a href="?c=Usuarios&a=actualizar&id=<?php echo $user->getIdUsuario() ?>" class="btn btn-info btn-sm mx-1" onclick="actualizar(this);"><i class="fas fa-pencil-alt"></i></a>
