<body>
	...
	<div class="container-fluid">
		...
		<!-- Área Principal -->
		<section class="row row row-cols-1 row-cols-sm-2 justify-content-center bg-light">			
					...
					<div class="card h-100">
						...
						<div class="card-body">
							<ul class="list-group list-group-flush">
							  <li class="list-group-item"><a href="?c=Usuarios&a=crear" class="card-link">Crear usuarios</a></li>
							  <li class="list-group-item"><a href="?c=Usuarios&a=consultar" class="card-link">Consultar Usuarios</a></li>							  
							</ul>
						</div>
					</div>
				</div>
