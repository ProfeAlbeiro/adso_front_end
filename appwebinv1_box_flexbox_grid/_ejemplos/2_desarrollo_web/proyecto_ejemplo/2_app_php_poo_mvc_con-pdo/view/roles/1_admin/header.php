			...
			<div class="col-lg-9 p-0">
				<div class="navbar navbar-expand-lg navbar-light">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav">
							<li class="nav-item active">
								<a href="?c=DashboardAdmin" class="nav-link text-white ocul-navbar">Inicio <span class="sr-only">(current)</span></a>
							</li>
						</ul>
						<ul class="navbar-nav">							
							<li class="nav-item">
								<a href="?c=Error404" class="nav-link text-white ocul-navbar">Correo</a>
							</li>
							<li class="nav-item">
								<a href="?c=Error404" class="nav-link text-white ocul-navbar">Calendario</a>
							</li>
							<li class="nav-item">
								<a href="?c=Error404" class="nav-link text-white ocul-navbar">Actividades</a>
							</li>
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
									<a href="?c=Error404" class="dropdown-item ocul-navbar">Configuración</a>
									...
									<div class="card">
										<ul class="list-group list-group-flush">
											<li class="list-group-item p-0 bg-light">
												<a href="?c=Usuarios&a=crear" class="card-link d-block p-2 px-lg-3 py-lg-1 ocul-aside">Crear Usuario</a>
											</li>
											<li class="list-group-item p-0 bg-light">
												<a href="?c=Usuarios&a=consultar"  class="card-link d-block p-2 px-lg-3 py-lg-1 ocul-aside">Consultar Usuarios</a>
											</li>
										</ul>
									</div>
								</div>
