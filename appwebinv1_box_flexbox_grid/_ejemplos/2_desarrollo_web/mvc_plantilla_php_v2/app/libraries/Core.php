<?php 
	...
	class Core{
		...
		public function __construct(){
			...
			// Llamar callback con parámetros por un Arreglo: Clase->controladorActual, Método de la
			// Clase->metodoActual, Parámetros del Método->parámetros. Esto para usarse en toda la 
			// aplicación
